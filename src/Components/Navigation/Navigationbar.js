        ...
        <>
            {['md'].map((expand) => (
                <Navbar key={expand} expand={expand} className="shadow-none mb-3">
                    <Container fluid>
                        <Navbar.Brand href="/">
                            <img src='/images/goldbullionslogo.png' alt='' className="n-icon"
                                style={{
                                    width: "210px",
                                    height: "86.35px",
                                }}
                        ...
                        <Navbar.Toggle aria-controls={`offcanvasNavbar-expand-${expand}`} className='navigbar'>
                        ...
                        >
                            ...
                            <Offcanvas.Body>
                                <Nav activeKey={activeKey} className="me-auto navigation">
                                    <Nav.Link className="aeonik nlink text-nowrap" as={Link} eventKey="/" to="/">Product</Nav.Link> &nbsp;&nbsp;
                                    <Nav.Link className="aeonik nlink text-nowrap" as={Link} eventKey="/about" to="/about">About Us</Nav.Link> &nbsp;&nbsp;
                                    <Nav.Link className="aeonik nlink text-nowrap" as={Link} eventKey="/contactus" to="/contactus">Contact Us</Nav.Link> &nbsp;&nbsp;
                                    <Nav.Link className="aeonik nlink faqs d-none " as={Link} eventKey="/FAQS" to="/FAQs">FAQs</Nav.Link> &nbsp;&nbsp;
                                </Nav>
                                <Nav>
                                    <button className="nav-bttn aeonik mobile-bttn d-none mt-5" style={{
                                        backgroundColor: "#014D85",
                                        color: "#FFF",
                                    }}>Get Started</button>
                                </Nav>
